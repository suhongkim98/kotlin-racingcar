...
class StringAddCalculator {
    companion object {
        ...
        private fun getTarget(input: String): String {
            return if(isCustomSeparatorInput(input)) {
        ...
        private fun isCustomSeparatorInput(input: String): Boolean {
            return regex.matches(input)
        }

        private fun getSeparators(input: String): Array<String> {
            // 커스텀 구분자 여부 확인
            return if(isCustomSeparatorInput(input)) {
